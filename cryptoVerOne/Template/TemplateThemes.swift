...
class TemplateThemes {
    static var share = TemplateThemes()
    // MARK: -
    // MARK: 步驟一 內部宣告可監聽狀態
    // 變換取款成功頁面上方狀態
    ...
    // MARK: 步驟三 內部宣告可綁定名稱
    // 綁定取款成功頁面 上方狀態View
    private static let topViewMode = TemplateThemes.share.topViewStatusStyle.asObservable()
    // MARK: -
    // MARK: 步驟四 內部宣告可綁定參數
