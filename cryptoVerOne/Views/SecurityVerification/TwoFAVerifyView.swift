...
class TwoFAVerifyView: UIView {
    ...
    // MARK: -
    // MARK:UI 設定
    var emailInputView = InputStyleView(inputViewMode: .emailVerify(KeychainManager.share.getLastAccountDto()?.account ?? ""))
...
//            .disposed(by: dpg)
    ...
    func rxSubmitOnlyTwoFAAction() -> Observable<(String)>
    {
