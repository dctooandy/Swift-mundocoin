...
class Fonts {
    ...
    static func PlusJakartaSansLight(_ size: CGFloat) -> UIFont {
        return UIFont(name: "PlusJakartaSans-Light", size: size) ?? UIFont.systemFont(ofSize: size)
    }
    static func PlusJakartaSansExtraLight(_ size: CGFloat) -> UIFont {
        return UIFont(name: "PlusJakartaSans-ExtraLight", size: size) ?? UIFont.systemFont(ofSize: size)
    }
    static func PlusJakartaSansMedium(_ size: CGFloat) -> UIFont {
        return UIFont(name: "PlusJakartaSans-Medium", size: size) ?? UIFont.systemFont(ofSize: size)
    }
    static func PlusJakartaSansRegular(_ size: CGFloat) -> UIFont {
        return UIFont(name: "PlusJakartaSans-Regular", size: size) ?? UIFont.systemFont(ofSize: size)
    }
    ...
    static func PlusJakartaSansBold(_ size: CGFloat) -> UIFont {
        return UIFont(name: "PlusJakartaSans-Bold", size: size) ?? UIFont.systemFont(ofSize: size)
    }
